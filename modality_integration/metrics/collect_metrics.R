...
write.table(combined.df, paste0(output_dir, "/summary_metrics.txt"), quote = F, sep = "\t", col.names = T, row.names = T)
...
write.table(combined.df, paste0(output_dir, "/per_cell_metrics.txt"), quote = F, sep = "\t", col.names = T, row.names = T)
